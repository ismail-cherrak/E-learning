...
import Line from './line';
    ...
    function Document({ onConfirm, onClose }) {
        ...
        const handledateChange = (event, index) => {
            const updatedElements = [...additionalElements];
            updatedElements[index].dateremise = event.target.value;
            setAdditionalElements(updatedElements);
        };
                    ...
                    <div className="border border-black rounded h-[540px] w-[500px] mx-auto p-4 relative overflow-y-scroll">
                        {additionalElements.map((element, index) => (
                            <div key={index} className="mb-2">
                                ...
                                <input type="date" className="border border-gray-800 focus:outline-none rounded-md py-2 px-2 m-1 w-full" value={element.dateremise} onChange={(e) => handledateChange(e, index)}/>
                                <input
                                    type="file"
                                    ref={fileInputRef}
                                    className="hidden"
...
function Cardone({ dateremise, description , file, title }) {
    return (
        <div className="m-2">
            <div className="border border-gray-100 rounded-lg shadow-md p-2 flex bg-red-100 items-center w-[635px]">
                ...
                <div className="flex-grow flex justify-center">
                <div className="text-xs font-semibold">  {dateremise} </div>
                </div>
...
Cardone.propTypes = {
    ...
    dateremise: PropTypes.Date.isRequired,
};
