...
//   return (
//     <div className="bg-white shadow-md rounded-md p-4 mb-4 mr-2">
//       <div className="flex items-start">
...
// // Main App component
// export const EspaceCollabEtu = ( { comments = [] }   , postId, onDeleteComment ) => {
...
export const EspaceCollabEtu = ( { comments = [] }   , postId, onDeleteComment ) => {
  ...
  return (
    <div className=" h-screen  bg-gray-100 flex flex-col ml-4">
